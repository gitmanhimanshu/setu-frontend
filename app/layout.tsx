...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Naukri automated job apply tool",
    "LinkedIn email extractor AI",
    "Open source AI email sender",
    "Send cold emails with ChatGPT",
    "Firecrawl AI web scraping jobs",
    "AI resume tailored applications",
    "AI job seeker tools 2026",
    "Free AI cold email generator",
    "Automate LinkedIn jobs AI",
  ],
  openGraph: {
    type: "website",
    url: SITE_URL,
